...
// Route::get('/noticias/categoria/{slug}', [NoticiaController::class, 'porCategoria'])->name('noticias.categoria');
// Route::get('/buscar', [NoticiaController::class, 'buscar'])->name('noticias.buscar');
Route::get('/noticias/load', [NoticiaController::class, 'loadMore'])->name('noticias.load');
